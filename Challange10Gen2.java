...
//In previous example  all the type if player added to team
//Here we have to add according to the team we create only
...
class Team <T>{
    ...
    public boolean addPlayer(T player) {
        if (members.contains(player)) {
            ...
            members.add(player);
            System.out.println(((Playerg)player).getName() + " picked for team " + this.name);
            return true;
        }
    }
